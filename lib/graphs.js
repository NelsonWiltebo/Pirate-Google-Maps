...
exports.black = exports.grey = exports.white = void 0;
...
function lg_bfs_visit_order(_a, initial) {
    ...
    var colour = build_array(size, function (_) { return exports.white; });
    // visit a white node
    function bfs_visit(current) {
        colour[current] = exports.grey;
    ...
    while (!(0, queue_array_1.is_empty)(pending)) {
        ...
        var adjacent_white_nodes = (0, list_1.filter)(function (node) { return colour[node] === exports.white; }, adj[current]);
        (0, list_1.for_each)(bfs_visit, adjacent_white_nodes);
        // paint current node black; the node is now done.
        colour[current] = exports.black;
    }
    return result;
}
/**
...
function lg_dfs_visit_order(_a, restart_order) {
    ...
    function dfs_visit(current) {
        if (colour[current] === exports.white) {
            colour[current] = exports.grey;
            (0, queue_array_1.enqueue)(current, result);
